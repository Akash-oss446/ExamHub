...
public class AuthenicateController {
    ...
    public ResponseEntity<?> generateToken(@RequestBody JwtRequest jwtRequest) throws Exception {
        ...
        UserDetails userDetails=this.userDetailsServicesimp.loadUserByUsername(jwtRequest.getUsername());
    ...
    {
        return ((User) this.userDetailsServicesimp.loadUserByUsername(principal.getName()));
    }
